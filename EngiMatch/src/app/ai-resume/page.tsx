    ...
    <div className="min-h-screen bg-gradient-to-br from-indigo-50 via-white to-slate-50">
      ...
      <div className="mx-auto max-w-3xl px-4 py-8">
        <div className="mb-10 text-center">
          <div className="mb-4 inline-flex items-center gap-2 rounded-full border border-indigo-200 bg-indigo-50 px-3 py-1.5 text-xs font-medium text-indigo-700">
            AI Resume
          </div>
          ...
          <div className="mb-8">
            ...
            <div className="flex gap-3">
              <div className="flex-1 rounded-xl border-2 border-indigo-600 bg-indigo-50 p-4">
                ...
                <div className="mt-0.5 text-xs text-indigo-600">{t("ai.uk_master_desc")}</div>
              </div>
            ...
            <div className="grid grid-cols-2 gap-2 md:grid-cols-3">
              {AI_RESUME_MAJOR_OPTIONS.map((option) => (
                ...
                >
                  ...
                  <div className={`mt-0.5 text-xs ${major === option.value ? "text-indigo-600" : "text-slate-400"}`}>
